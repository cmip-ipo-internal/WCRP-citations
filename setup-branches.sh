...
echo "   - Go to: https://github.com/cmip-ipo-internal/citation-mapper/settings/branches"
echo "   - Under 'Default branch', click the switch icon"
echo "   - Select 'src-data'"
echo "   - Click 'Update' and confirm"
echo ""
echo "2. GitHub CLI (gh):"
echo "   gh api repos/cmip-ipo-internal/citation-mapper -X PATCH -f default_branch='src-data'"
echo ""
